...
/* 		echo "season: ". $season. "<br/>";
	...
	?>
		<form action= "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="get" id="search">  
			<select  name="standingsYear" id="standingsYear" class="dropDown" onchange='this.form.submit()'>
				<option <?php if (($_GET['standingsYear'] == '20182019') || !isset($_GET['standingsYear'])) { ?>selected="true" <?php }; ?>value="20182019">2018-2019</option>
					<option <?php if ($_GET['standingsYear'] == '20172018') { ?>selected="true" <?php }; ?>value="20172018">2017-2018</option>
				<option <?php if ($_GET['standingsYear'] == '20162017') { ?>selected="true" <?php }; ?>value="20162017">2016-2017</option>
	...
	<?php
		...
		if (($standingsType == 'wildcard') && (($year == '20162017') || ($year == '20172018'))) {
			wildCardQuery($db,$year);
		} 
